...
var rootCmd = &cobra.Command{
	Use:   "multi-oauth2-proxy",
	Short: "Multi OAuth2 Proxy - Unified authentication reverse proxy",
	Long: `Multi OAuth2 Proxy is a reverse proxy that provides unified authentication
